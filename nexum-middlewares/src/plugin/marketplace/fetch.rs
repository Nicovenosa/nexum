...
pub(crate) async fn fetch_npm(
    ...
    // ALLOW justificado: ya lleva UUID, que es más fuerte que el PID —
    // aísla incluso entre invocaciones del MISMO proceso, y acá hace falta
    // porque un proceso puede bajar varios paquetes a la vez.
