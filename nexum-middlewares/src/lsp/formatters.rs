...
use nexum_lsp::protocol::lsp_types;
...
/// 格式化诊断结果
pub fn format_diagnostics(entries: &[nexum_lsp::diagnostics::DiagnosticEntry]) -> String {
    if entries.is_empty() {
    ...
    let mut file_groups: std::collections::HashMap<
        String,
        Vec<&nexum_lsp::diagnostics::DiagnosticEntry>,
    ...
    for (file_uri, entries) in &file_groups {
        ...
        for entry in entries {
            let severity = match entry.severity {
                nexum_lsp::diagnostics::DiagnosticSeverity::Error => "Error",
                nexum_lsp::diagnostics::DiagnosticSeverity::Warning => "Warning",
                nexum_lsp::diagnostics::DiagnosticSeverity::Information => "Info",
                nexum_lsp::diagnostics::DiagnosticSeverity::Hint => "Hint",
            };
            lines.push(format!(
                "  {}:{}: [{}] {}",
