// 从核心库导入 trait 和数据类型
pub use nexum_agent::ask_user::{AskUserBatchRequest, AskUserOption, AskUserQuestionData};
use nexum_agent::{agent::react::ToolCall, error::AgentError};
...
pub fn ask_user_tool_definition() -> nexum_agent::tools::ToolDefinition {
    nexum_agent::tools::ToolDefinition {
