...
use nexum_agent::error::AgentError;
use nexum_agent::goal::{GoalController, GoalStatus, GoalViewSnapshot};
use nexum_agent::llm::types::StopReason;
use nexum_agent::llm::{BaseModel, LlmRequest, LlmResponse};
use nexum_agent::tools::ToolContext;
...
impl BaseModel for MockBaseModel {
    async fn invoke(&self, _request: LlmRequest) -> nexum_agent::error::AgentResult<LlmResponse> {
