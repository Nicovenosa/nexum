...
pub fn default_registry() -> CommandRegistry {
    ...
    r.register(Box::new(panel::provider::ProviderCommand));
    ...
    r.register(Box::new(session::hormiguero::HormigueroCommand));
    r.register(Box::new(session::nocturno::NocturnoCommand));
    r.register(Box::new(session::memoria::MemoriaCommand));
    r.register(Box::new(session::voz::VozCommand));
...
impl CommandRegistry {
    ...
    pub fn register_plugin_commands(
        &mut self,
        commands: Vec<nexum_middlewares::plugin::CommandEntry>,
    ) {
