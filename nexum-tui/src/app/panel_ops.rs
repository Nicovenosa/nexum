...
impl App {
    ...
    pub async fn new_headless(
        ...
        let thread_store: Arc<dyn ThreadStore> = Arc::new(
            #[allow(clippy::disallowed_methods)] // db_name lleva UUID v7 (línea de arriba)
        ...
        #[allow(clippy::disallowed_methods)] // lleva UUID v7 (línea de abajo)
        ...
        let session = super::ChatSession {
            ...
            spinner_state: nexum_widgets::SpinnerState::new(nexum_widgets::SpinnerMode::Idle),
        };
        ...
        let app = App {
            ...
            services: super::ServiceRegistry {
                nexum_config: std::sync::Arc::new(parking_lot::RwLock::new(
                    crate::config::NexumConfig::default(),
                )),
                cwd: "/tmp".to_string(),
                provider_name: "test".to_string(),
                model_name: "test-model".to_string(),
                permission_mode: nexum_middlewares::prelude::SharedPermissionMode::new(
                ...
                #[allow(clippy::disallowed_methods)] // lleva UUID v7
