...
impl MessagePipeline {
    ...
    pub(crate) fn build_tail_vms(&self) -> Vec<MessageViewModel> {
        ...
        // Turn grouping: un solo header/footer de NEXUM por turno (streaming).
        // Corre AL FINAL, tras agregar streaming bubble + tools, para que el
        // footer caiga en la última burbuja real del turno.
        crate::ui::message_view::group_turn_cards(&mut tail_vms);
