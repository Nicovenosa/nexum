use nexum_acp::transport::types::RequestId;
use nexum_middlewares::hitl::BatchItem;
...
impl App {
    ...
    pub(crate) fn handle_interaction_request(
        &mut self,
        ctx: nexum_agent::interaction::InteractionContext,
        response_tx: tokio::sync::oneshot::Sender<nexum_agent::interaction::InteractionResponse>,
    ) -> (bool, bool, bool) {
