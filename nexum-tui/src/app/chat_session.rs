...
use nexum_middlewares::prelude::{SkillMetadata, TodoItem};
...
pub struct ChatSession {
    ...
    pub spinner_state: nexum_widgets::SpinnerState,
}
...
impl ChatSession {
    pub fn new(
        ...
        let _ = render_tx.try_send(crate::ui::render_thread::RenderEvent::SetLocale(
            lc.current_lang().to_string(),
        ));
        let _ = render_tx.try_send(crate::ui::render_thread::RenderEvent::SetCopyButtonLabel(
            lc.tr("copy-response-button").to_string(),
        ));
