...
#[cfg(test)]
mod tests {
    // ALLOW justificado: los temporales del test incluido llevan PID o UUID;
    // sin recurso compartido entre procesos. Va acá y no en el archivo porque
    // se incluye con include!, donde un atributo interno es inválido.
