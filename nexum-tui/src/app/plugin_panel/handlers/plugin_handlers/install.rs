use nexum_middlewares::plugin::InstallScope;
...
impl PluginPanel {
    ...
    pub(super) fn spawn_install_current(&mut self, ctx: &PanelContext<'_>) {
        ...
        let claude_dir = nexum_middlewares::plugin::claude_home();
        let cache_dir = nexum_middlewares::plugin::marketplaces_cache_dir();
