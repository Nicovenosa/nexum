...
/// Idiomas ofrecidos, con el nombre en ASCII primero.
///
/// `中文` a secas sale como cuadraditos en una terminal sin fuente CJK — y la
/// pantalla donde elegís el idioma es justo donde no podés permitirte que una
/// opción sea ilegible. El nombre nativo queda igual, después, para quien sí
/// puede verlo.
pub const LANGUAGE_OPTIONS: [(&str, &str); 3] = [
    ("en", "English"),
    ("zh-CN", "Chinese (中文)"),
    ("es-AR", "Espanol (Español)"),
];
