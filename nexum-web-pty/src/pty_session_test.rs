...
fn test_pty_session_spawn_uses_cwd() {
    ...
    // ALLOW justificado: se usa como CWD del proceso, no se escribe nada.
    // No hay recurso que compartir ni colisión posible, y el test verifica
    // justamente que la ruta sea válida en cualquier plataforma.
